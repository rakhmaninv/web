  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $job_exp[$i]['name']?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $job_exp[$i]['start_date']?> - 
            <?php if ($i == 0): ?>
                <span class="w3-tag w3-teal w3-round"><?php echo $job_exp[$i]['end_date']?></span>
            <?php else: ?>
                <?php echo $job_exp[$i]['end_date']?>
            <?php endif; ?>
          </h6>
